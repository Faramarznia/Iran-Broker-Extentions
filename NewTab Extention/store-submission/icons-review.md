...
> **به‌روزرسانی:** ۱۶×۱۶ و ۳۲×۳۲ رفع شدند (پایین را ببینید) — جدول زیر همان یافتهٔ اولیه است، برای مستندسازی مسئله دست‌نخورده نگه داشته شده.
...
## وضعیت فعلی (به‌روزرسانی ۲۰۲۶-۰۸-۱۵)

۱۶×۱۶ و ۳۲×۳۲ با همان دو دستور `sips` بالا اصلاح شدند و اکنون ابعاد واقعی درست دارند (تأیید با `file`). **۱۲۸×۱۲۸ همچنان اصلاح‌نشده باقی است** — طبق توضیح بالا، بدون آرت‌ورک منبع باکیفیت‌تر (که در ریپازیتوری وجود ندارد) قابل تولید صادقانه نیست؛ فایل فعلی همچنان همان تصویر ۴۸px بزرگ‌نمایی‌شده است.
