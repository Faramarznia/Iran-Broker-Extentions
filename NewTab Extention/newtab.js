...
(function () {
  ...
  const ICONS = {
    ...
    tag: '<g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41L13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></g>',
  ...
  const ENGINES = {
    ...
    airo: { label: 'آیرا', icon: 'search', logo: '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M11 2.5l1.85 5.4a1.4 1.4 0 0 0 .87.87l5.4 1.85-5.4 1.85a1.4 1.4 0 0 0-.87.87L11 18.75l-1.85-5.41a1.4 1.4 0 0 0-.87-.87L2.87 10.6l5.41-1.84a1.4 1.4 0 0 0 .87-.87L11 2.5z"/><path fill="currentColor" opacity=".55" d="M18.6 14.6l.9 2.6 2.6.9-2.6.9-.9 2.6-.9-2.6-2.6-.9 2.6-.9.9-2.6z"/></svg>', url: null }
  };
